...
<button type="button" class="btn btn-primary btn-block" onclick="cargarmodal2('<?php echo $this->Html->url(array('action' => 'comboclientes1',$campoform,$div));?>');"><?php echo $scliente['Cliente']['nombre'];?></button>
